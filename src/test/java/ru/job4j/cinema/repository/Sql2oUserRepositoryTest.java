...
public class Sql2oUserRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        var user = new User(1, "Vasya Pupkin", "vasya@mail.ru", "123");
    ...
    public void whenSaveSeveralThenGetAll() {
        var user1 = new User(1, "Vasya Pupkin", "vasya@mail.ru", "123");
        var user2 = new User(2, "Petya Bobrov", "petya@mail.ru", "456");
        var user3 = new User(3, "Kolya Morozov", "kolya@mail.ru", "789");
    ...
    public void whenFailToSaveTheSameEmail() {
        var user1 = new User(1, "Vasya Pupkin", "vasya@mail.ru", "123");
        var user2 = new User(2, "Petya Bobrov", "vasya@mail.ru", "456");
        sql2oUserRepository.save(user1);
